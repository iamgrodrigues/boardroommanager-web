import { BoardroomDetailsComponent } from 'src/app/boardroom-details/boardroom-details.component';
...
export class BoardroomListComponent implements OnInit {
  ...
  reloadData() {
    this.boardrooms = this.boardroomService.getBoardroomsList();
  }

  deleteBoardroom(id: number) {
